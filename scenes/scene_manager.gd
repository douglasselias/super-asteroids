...
onready var game_over_scene = preload("res://scenes/GameOverMenu.tscn")
...
onready var meteor_spawner_node = preload("res://scenes/meteor_spawner.tscn").instance()
onready var energy_node = preload("res://scenes/Energy.tscn").instance()
onready var score_node = preload("res://scenes/Score.tscn").instance()
